...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("hand_id", sa.Uuid(), nullable=True),
        sa.Column("created_at", sa.DateTime(timezone=True), server_default=sa.func.now(), nullable=False),
    )
    ...
    op.create_table(
        ...
        sa.Column("host_user_id", sa.Uuid(), sa.ForeignKey("users.id"), nullable=False),
        sa.Column("created_at", sa.DateTime(timezone=True), server_default=sa.func.now(), nullable=False),
    )
    ...
    op.create_table(
        "table_seats",
        sa.Column("id", sa.Uuid(), primary_key=True),
        sa.Column("table_id", sa.Uuid(), sa.ForeignKey("tables.id"), nullable=False),
        sa.Column("user_id", sa.Uuid(), sa.ForeignKey("users.id"), nullable=False),
    ...
    op.create_table(
        "hand_actions",
        sa.Column("id", sa.Uuid(), primary_key=True),
        sa.Column("hand_id", sa.Uuid(), sa.ForeignKey("hands.id"), nullable=False),
